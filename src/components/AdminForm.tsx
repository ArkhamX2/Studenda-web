                ...
                {selectedSubject !== undefined
                    ...
                    <>
                        <div style={{ display: 'flex', justifyContent: 'space-around', alignItems: 'center', flexDirection: 'column', width: '100%' }}>
                            ...
                            <StudendaSelect title="Дисциплина" options={disciplinesOptions} onChange={(value: { value: number; }) => setSelectedSubject({ ...selectedSubject!, disciplineId: findDiscipline(value?.value!)?.id! })} defaultValue={disciplinesOptions.find((obj) => { return obj.value === selectedSubject.disciplineId })} isClearable={true} placeholder='Выберите дисциплину'></StudendaSelect>
                            <StudendaSelect title="Тип занятия"
                                ...
                                isClearable={true}
                                placeholder='Выберите тип занятия'></StudendaSelect>
                            <StudendaSelect
                                title="Преподаватель"
                                ...
                                isClearable={true}
                                placeholder='Выберите преподавателя'></StudendaSelect>
                            <AdminInput title="Аудитория" onChange={e => setSelectedSubject({ ...selectedSubject!, classroom: e.target.value })} defaultValue={selectedSubject?.classroom} text='Выберите аудиторию'/>
