...
export const RequestValue:IRequestValue = {value:[
    ...
    {id:11,name:"schedule",route:"api/schedule/subject/group?"},
]}

export const request = async (RequestValueId:number, method:string, data:undefined|any=undefined, params:undefined|any=undefined, headers:undefined|any=undefined) => {   
    try {
        if (RequestValue.value[RequestValueId].route!=="")
        {
            ...
            const url = "http://88.210.3.137/"+RequestValue.value[RequestValueId].route
